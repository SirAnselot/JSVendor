...
Add script path to `"vendor"` array in file  [**WS-Base**](https://github.com/SirAnselot/WS-Base/)/grunt/[vendorBridge.json](https://github.com/SirAnselot/WS-Base/blob/master/grunt/vendorBridge.json) like so:
